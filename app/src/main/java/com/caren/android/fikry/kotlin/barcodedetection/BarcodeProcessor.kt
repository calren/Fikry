...
import com.caren.android.fikry.kotlin.camera.CameraReticleAnimator
...
import com.caren.android.fikry.kotlin.camera.FrameProcessorBase
import com.caren.android.fikry.kotlin.settings.PreferenceUtils
...
class BarcodeProcessor(graphicOverlay: GraphicOverlay, private val workflowModel: WorkflowModel) :
    ...
    val options = FirebaseVisionBarcodeDetectorOptions.Builder()
            .setBarcodeFormats(
                    FirebaseVisionBarcode.FORMAT_EAN_13 // Scan for ISBN
            )
            .build()
